...
public class Birthday {
    ...
    public Birthday(Integer d, Integer m, Integer a) {
        setDia(d);
        setMes(m);
        setAnio(a);
    }
    ...
    public void setFecha(Integer d, Integer m, Integer a) {
    ...
    public void mayorFecha(Birthday uno) {
    ...
    public int comparar(Birthday f1) {
